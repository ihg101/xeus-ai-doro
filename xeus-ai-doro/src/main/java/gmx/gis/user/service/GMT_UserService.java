 ...
 */
@Service
public class GMT_UserService extends EgovAbstractServiceImpl {

    @Autowired private GMT_UserMapper mapper;
	 ...
	 * @throws Exception
	 */
	public ArrayList<GMT_UserVo> getList(HashMap<String, String> map) throws Exception {

		ArrayList<GMT_UserVo> list = (ArrayList<GMT_UserVo>) mapper.getList(map);
	 ...
	 * @throws Exception
	 */
	public GMT_UserVo getItem(HashMap<String, String> map) throws Exception {

		GMT_UserVo vo = mapper.getItem(map);
	 ...
	 * @throws Exception
	 */
	public GMT_UserVo getItem(String userId) throws Exception {
	...
	public ArrayList<GMT_UserVo> getAgeStat(HashMap<String, String> map) throws Exception {

		ArrayList<GMT_UserVo> list = (ArrayList<GMT_UserVo>) mapper.getAgeStat(map);
	 ...
	 * @throws Exception
	 */
	public boolean add(GMT_UserVo vo) throws Exception {
	 ...
	 * @throws Exception
	 */
	public boolean edit(GMT_UserVo vo) throws Exception {
