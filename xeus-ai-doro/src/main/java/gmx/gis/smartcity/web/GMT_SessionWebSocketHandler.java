 ...
 * </pre>
 */
public class GMT_SessionWebSocketHandler extends TextWebSocketHandler {
	...
	@Autowired private GMT_SessionWebSocketService sessionWebSocketService;

    @Override
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
    	sessionWebSocketService.addClient(session);
    }
    ...
    public void afterConnectionClosed(WebSocketSession session, CloseStatus status) throws Exception {
    	sessionWebSocketService.removeClient(session);
    }
}
