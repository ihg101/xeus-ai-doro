...
public class GMT_AccessVo {
	...
	public String toString() {
		return "GMT_AccessVo [mgrSeq=" + mgrSeq + ", usrId=" + usrId + ", authMgrNo=" + authMgrNo + ", useTime=" + useTime
				+ ", allowYn=" + allowYn + ", connIp=" + connIp + ", rmark=" + rmark + "]";
	}
