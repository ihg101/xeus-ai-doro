 ...
 *
 * <pre>
 * 레이어의 테마 스타일 정보를 담당합니다.
 * </pre>
 *
 * @author 이주영
 *
 */
public class GMT_LayerThemeVo {

	private int mgrSeq;
	private int lyrMgrSeq;
	private String thmFieldId;
	private String thmFieldNm;
	private String thmFieldTyp;
	private String thmStartVal;
	private String thmEndVal;
	...
	public String getThmFieldId() {
		return thmFieldId;
	}
	public String getThmFieldNm() {
		return thmFieldNm;
	}
	public String getThmFieldTyp() {
		return thmFieldTyp;
	}
	public String getThmStartVal() {
		return thmStartVal;
	}
	public String getThmEndVal() {
		return thmEndVal;
	}
	...
	public void setThmFieldId(String thmFieldId) {
		this.thmFieldId = thmFieldId;
	}
	public void setThmFieldNm(String thmFieldNm) {
		this.thmFieldNm = thmFieldNm;
	}
	public void setThmFieldTyp(String thmFieldTyp) {
		this.thmFieldTyp = thmFieldTyp;
	}
	public void setThmStartVal(String thmStartVal) {
		this.thmStartVal = thmStartVal;
	}
	public void setThmEndVal(String thmEndVal) {
		this.thmEndVal = thmEndVal;
	}
	...
	public String toString() {
		return "GMT_LayerThemeVo [mgrSeq=" + mgrSeq + ", lyrMgrSeq=" + lyrMgrSeq + ", thmFieldId=" + thmFieldId
				+ ", thmFieldNm=" + thmFieldNm + ", thmFieldTyp=" + thmFieldTyp + ", thmStartVal=" + thmStartVal
				+ ", thmEndVal=" + thmEndVal + ", strokeColor=" + strokeColor + ", strokeWidth=" + strokeWidth
				+ ", strokeLineDash=" + strokeLineDash + ", fillColor=" + fillColor + ", textTextAlign=" + textTextAlign
				+ ", textTextBaseline=" + textTextBaseline + ", textFont=" + textFont + ", textText=" + textText
				+ ", textFillColor=" + textFillColor + ", textStrokeColor=" + textStrokeColor + ", textStrokeWidth="
				+ textStrokeWidth + ", textOffsetX=" + textOffsetX + ", textOffsetY=" + textOffsetY + ", textRotation="
				+ textRotation + ", circleRadius=" + circleRadius + ", calcMethod=" + calcMethod + ", iconMgrSeq="
