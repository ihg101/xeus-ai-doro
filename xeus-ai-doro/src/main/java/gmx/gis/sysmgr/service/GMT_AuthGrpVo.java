...
public class GMT_AuthGrpVo implements Serializable {

	/**
	 *
	 */
	private static final long serialVersionUID = -1124999764096985493L;
	...
	public String toString() {
		return "GMT_AuthGrpVo [authGrpNo=" + authGrpNo + ", authGrpNm=" + authGrpNm + ", authMgrNo=" + authMgrNo
