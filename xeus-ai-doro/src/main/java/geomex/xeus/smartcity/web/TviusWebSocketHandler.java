 ...
 * </pre>
 */
public class TviusWebSocketHandler extends TextWebSocketHandler {
    ...
    private TviusWebSocketService tviusWebSocketService;

    @Override
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
    	tviusWebSocketService.addClient(session);
    }
    ...
    public void afterConnectionClosed(WebSocketSession session, CloseStatus status) throws Exception {
    	tviusWebSocketService.removeClient(session);
    }
}
