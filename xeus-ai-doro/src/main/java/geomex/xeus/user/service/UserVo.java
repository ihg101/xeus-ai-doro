...
public class UserVo {
	...
	public String toString() {
		return "UserVo [userId=" + userId + ", userNm=" + userNm + ", userPwd=" + userPwd + ", birthDay=" + birthDay
				+ ", authGrpNo=" + authGrpNo + ", orgMgrNo=" + orgMgrNo + ", telNum=" + telNum + ", email=" + email
				+ ", authStatCd=" + authStatCd + ", reqDat=" + reqDat + ", acptDat=" + acptDat + ", lockDat=" + lockDat
				+ ", exprDat=" + exprDat + ", acptUserId=" + acptUserId + ", oathFileNm=" + oathFileNm
				+ ", oathFilePath=" + oathFilePath + ", userIdOrNm=" + userIdOrNm + ", authGrpNm=" + authGrpNm
				+ ", orgNm=" + orgNm + ", mobileNum=" + mobileNum + ", departNm=" + departNm + ", posNm=" + posNm
				+ ", authAtmtCnt=" + authAtmtCnt + ", authConnIp=" + authConnIp + ", subDir=" + subDir + ", boardInfo="
				+ boardInfo + ", age=" + age + ", count=" + count + ", accNo=" + accNo + ", outSign=" + outSign
				+ ", outStream=" + outStream + ", loginSms=" + loginSms + ", file=" + file + "]";
	}
