 ...
 * @see
 */
@Mapper("sysPropMapper")
public interface SysPropMapper {
	...
	public int add(SysPropVo vo) throws Exception;

	public int edit(SysPropVo vo) throws Exception;

	public int editSysParam(HashMap<String, Object> map) throws Exception;
