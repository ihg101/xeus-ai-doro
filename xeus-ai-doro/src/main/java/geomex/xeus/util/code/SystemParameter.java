...
*/
    ...
    public SystemParameter(ArrayList<SysPropVo> parmaList){
     ...
     * @return map
     */
    /*public static HashMap<String, String> convertParam(ArrayList<SysPropVo> parmaList){
    ...
    /*public String toString() {
        return "SystemParameter [aviPlayCnt=" + aviPlayCnt + ", aviPlayDat=" + aviPlayDat
