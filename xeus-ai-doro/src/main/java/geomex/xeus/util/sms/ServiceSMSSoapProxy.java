...
public class ServiceSMSSoapProxy implements geomex.xeus.util.sms.ServiceSMSSoap {
	private String _endpoint = null;
	private geomex.xeus.util.sms.ServiceSMSSoap serviceSMSSoap = null;
	...
	try {
		serviceSMSSoap = (new geomex.xeus.util.sms.ServiceSMSLocator()).getServiceSMSSoap();
	...
	public geomex.xeus.util.sms.ServiceSMSSoap getServiceSMSSoap() {
	if (serviceSMSSoap == null)
		_initServiceSMSSoapProxy();
