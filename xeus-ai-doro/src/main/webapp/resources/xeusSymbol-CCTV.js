 ...
 * @version 1.0r
 */
if(window.xeusSymbolCctv == null) var xeusSymbolCctv = {
	 ...
	 */
	getVector : function(){
		return GMXMAP.getLayerByName("xeusSymbolCctv");
	},
	 ...
	 * @returns {___anonymous_xeusSymbolCctv}
	 */
	createVector : function(_Map){
		this.vectorSource = new ol.source.Vector();
		this.vector = new ol.layer.Vector({
			name: "xeusSymbolCctv",
			source: xeusSymbolCctv.vectorSource,
			zIndex: 7
		});
