...
$(document).ready(function(){
	...
	$.getScript("./res/menu/tviusMngView/gmx.page.menu.js?v=" + v, function(){});
	 ...
	 * 반출 웹소켓 생성
	 */
	if(window.tviusSocket == null){
		window.tviusSocket = new TviusWS();
		window.tviusSocket.create("ws://" + location.host + "/xeus/tviusWs");
	}
	/**
	 * 이벤트 웹소켓 생성
	 */
