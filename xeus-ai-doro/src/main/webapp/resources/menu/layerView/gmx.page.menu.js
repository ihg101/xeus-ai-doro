...
(function(){
	...
	$(".startMenu").click(function(){
		if($("#createNewLayerWrap").dialog("isOpen")){
			$("#createNewLayerWrap").dialog("close");
		}
		if($("#shareLayerWrap").dialog("isOpen")){
			$("#shareLayerWrap").dialog("close");
		}
		if($("#importShpWrap").dialog("isOpen")){
			$("#importShpWrap").dialog("close");
		}
		if($("#exportShpWrap").dialog("isOpen")){
			$("#exportShpWrap").dialog("close");
		}
		if($("#uploadExcelWrap").dialog("isOpen")){
