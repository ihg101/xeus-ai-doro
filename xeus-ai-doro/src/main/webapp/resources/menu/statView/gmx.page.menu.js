...
//		if(btnId === "btn-user-stat-view"){
//			$("#contentWrap").dialog("option", "width", 1800);
//		}
//		if(btnId === "btn-evt-stat-view"){
//			$("#contentWrap").dialog("option", "width", 1800);
//		}
//		if(btnId === "btn-equip-stat-view"){
//			$("#contentWrap").dialog("option", "width", 1800);
//		}
//		if(btnId === "btn-cctv-stat-view"){
//			$("#contentWrap").dialog("option", "width", 1800);
//		}
//		if(btnId === "btn-cctv-heat-view"){
//			$("#contentWrap").dialog("option", "width", 1000);
//		}
//		if(btnId === "btn-anna-mng"){
//			$("#contentWrap").dialog("option", "width", 1800);
//		}
...
//					GMXMAP.setLayerVisible("asset_statistics_sig",false);
				}
			}).dialog("open");
		}, false);
	}
