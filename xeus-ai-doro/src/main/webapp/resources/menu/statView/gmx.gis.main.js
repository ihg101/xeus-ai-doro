...
$(document).ready(function(){
	...
	$.getScript("./res/menu/statView/gmx.page.menu.js?v=" + v, function(){});
...
//	}
	...
	$("#btn-lgd-mng").click(function(){
		$("#legendWrap").dialog({
			...
			open: function() {
				$(this).dialog("option", "maxHeight", $("#smallMap").height());
			}
		}).dialog("open");
	});
	...
	$(window).resize(function(){
		$("#legendWrap").dialog("option", "height", $("#smallMap").height());
		$("#featureInfoWrap").dialog("option", "height", $("#smallMap").height());
