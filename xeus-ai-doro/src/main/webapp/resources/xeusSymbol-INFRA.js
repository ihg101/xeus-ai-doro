 ...
 * @version 1.0r
 */
if(window.xeusSymbolInfra == null) var xeusSymbolInfra = {
	 ...
	 */
	getVector : function(){
		return GMXMAP.getLayerByName("xeusSymbolInfra");
	},
	 ...
	 * @returns {___anonymous_xeusSymbolInfra}
	 */
	createVector : function(_Map){
		this.vectorSource = new ol.source.Vector();
		this.vector = new ol.layer.Vector({
			name: "xeusSymbolInfra",
			source: xeusSymbolInfra.vectorSource,
			zIndex: 7
		});
