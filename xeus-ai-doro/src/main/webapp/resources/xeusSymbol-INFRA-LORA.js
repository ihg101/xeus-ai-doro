 ...
 * @version 1.0r
 */
if(window.xeusSymbolInfraLora == null) var xeusSymbolInfraLora = {
	 ...
	 */
	getVector : function(){
		return GMXMAP.getLayerByName("xeusSymbolInfraLora");
	},
	 ...
	 * @returns {___anonymous_xeusSymbolInfraLora}
	 */
	createVector : function(_Map){
		this.vectorSource = new ol.source.Vector();
		this.vector = new ol.layer.Vector({
			name: "xeusSymbolInfraLora",
			source: xeusSymbolInfraLora.vectorSource,
			zIndex: 7
		});
