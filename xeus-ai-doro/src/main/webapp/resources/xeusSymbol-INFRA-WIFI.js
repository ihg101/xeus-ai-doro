 ...
 * @version 1.0r
 */
if(window.xeusSymbolInfraWifi == null) var xeusSymbolInfraWifi = {
	 ...
	 */
	getVector : function(){
		return GMXMAP.getLayerByName("xeusSymbolInfraWifi");
	},
	 ...
	 * @returns {___anonymous_xeusSymbolInfraWifi}
	 */
	createVector : function(_Map){
		this.vectorSource = new ol.source.Vector();
		this.vector = new ol.layer.Vector({
			name: "xeusSymbolInfraWifi",
			source: xeusSymbolInfraWifi.vectorSource,
			zIndex: 7
		});
