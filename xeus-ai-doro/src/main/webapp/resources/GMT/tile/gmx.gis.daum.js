		...
		return new ol.layer.Tile({
			...
			source  : new ol.source.XYZ({
				...
				tileUrlFunction: function (coordinate) {
					...
					return  "/xeus/GMT_proxy/dmz?url=https://map.daumcdn.net/map_k3f_prod/bakery/image_map_png/PNGSD01/v22_ke29h" +"/"+ level + "/" + row + "/" + col + ".png";

					//return _PROXY_TILE_DATA_URL_ + "https://map.daumcdn.net/map_k3f_prod/bakery/image_map_png/PNGSD01/v26_xnfzm/" + level + "/" + row + "/" + col + ".png";
				},
		...
		return new ol.layer.Tile({
			...
			source  : new ol.source.XYZ({
				...
				tileUrlFunction: function (coordinate) {
					...
					return _PROXY_TILE_DATA_URL_ + "http://map" + subdomain + ".daumcdn.net/map_hybrid_hd/2205pfk/L" + level + "/" + row + "/" + col + ".png";
				},
				tileGrid: new ol.tilegrid.TileGrid({
					origin: _Origin,
					resolutions: _Resolutions
