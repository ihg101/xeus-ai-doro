 ...
 * @author 이주영
 */
ol.Map.prototype.addCustomMeasure = function(Map, addBoolean){

	var _Map = this;
	if(Map != null || Map instanceof ol.Map) _Map = Map;

	var _Bool = addBoolean;
	if(!addBoolean) _Bool = true;
