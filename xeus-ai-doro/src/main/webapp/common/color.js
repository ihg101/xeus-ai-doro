 ...
 * <pre>
 * Color 객체입니다.
 * ol.style.Style 객체, 일반 프로퍼티 등을 관리합니다.
 *
 * @API http://openlayers.org/en/latest/apidoc/ol.style.Stroke.html
 *
 * @author 이주영
 * </pre>
 */
if(window.GmxColor == null) var GmxColor = {

	/**
	 * <pre>
	 * 기본 하이라이트 스타일 객체를 리턴합니다.
	 * RGB 값은 255,255,255 와 같은 형식입니다.
	 * 올바르지 않을 경우 OL3 기본 벡터 스타일로 지정됩니다.
	 *
	 * 필수) name - RGB 또는 색상명 (String)
	 *
	 * @returns {ol.style.Style}
	 *
	 * @Note 대쉬, 도트 등의 스타일은 분리하여 제작될 예정입니다.
	 * </pre>
	 */
	getNormalStyle : function(name){
		var rgb = name;
		try {
			rgb = this[name.toLowerCase()].rgb
		} catch (e) {
			console.error(">> RGB 또는 색상명이 올바르지 않습니다.");
		}
		if(rgb != null){
