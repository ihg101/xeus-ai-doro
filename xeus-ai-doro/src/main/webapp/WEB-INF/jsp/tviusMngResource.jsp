...
<link rel="stylesheet" type="text/css" href="./common/toastr/toastr.min.css?c=<%= c %>">
...
<script type="text/javascript" src="./common/jszip.js?c=<%= c %>"></script>
<script type="text/javascript" src="./common/jszip-utils.min.js?c=<%= c %>"></script>
<script type="text/javascript" src="./common/capture/FileSaver.min.js?c=<%= c %>"></script>
...
<script type="text/javascript" src="./common/sysMngSort.js?c=<%= c %>"></script>

<script type="text/javascript" src="./common/toastr/toastr.min.js?c=<%= c %>"></script>
...
<script type="text/javascript" src="./res/xeusTviusWebSocket.js?c=<%= c %>"></script>
...
<script type="text/javascript" src="./res/menu/tviusView/xeusGlobal-TVIUS.js?c=<%= c %>"></script>
<script type="text/javascript" src="./res/menu/tviusMngView/gmx.gis.main.js?c=<%= c %>"></script>
<script type="text/javascript" src="./res/menu/tviusMngView/gmx.cctv.js?c=<%= c %>"></script>
