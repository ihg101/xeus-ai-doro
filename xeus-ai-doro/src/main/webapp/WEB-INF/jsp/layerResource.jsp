...
<script type="text/javascript" src="./res/menu/layerView/gmx.gis.main.js?c=<%= c %>"></script>
<script type="text/javascript" src="./res/menu/layerView/gmx.cctv.js?c=<%= c %>"></script>
