...
<script type="text/javascript" src="./res/menu/statView/xeusGlobal-STAT.js?c=<%= c %>"></script>
<script type="text/javascript" src="./res/menu/statView/gmx.gis.main.js?c=<%= c %>"></script>
<script type="text/javascript" src="./res/menu/statView/gmx.cctv.js?c=<%= c %>"></script>
