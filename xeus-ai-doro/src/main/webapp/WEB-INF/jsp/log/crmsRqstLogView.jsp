    ...
    <div id="wrap">
        <div id="menuWrap" class="box_style">
        	<div class="info_box wd100">
        		<div id="selector">
	        		<select>
		                <option url="/log/getCrmsRqstLogView.do" selected>영상반출신청 로그조회</option>
...
<!-- 		                <option url="/log/getCrmsRqstCarLogView.do">차량영상반출 로그조회</option> -->
		            ...
		            <div class="hidden" id="title" url="/log/getCrmsRqstLogView.do" excel = "Rqst">영상반출신청 로그</div>
        		</div>
        ...
        <!-- <p class="searchTitle">
            <button class="logTab" url="/log/gestAssetLogView.do" excel="Asset">시설물 관리</button>
...
%> --%>
						<th><span id='rqst.mgr_seq' class='mngSortBtn' url='/log/getCrmsRqstLogView.do' >신청번호</span></th>
						<th><span id='rqst.reqst_id' class='mngSortBtn' url='/log/getCrmsRqstLogView.do' >신청자ID</span></th>
						<th><span id='reqst_id_rel.user_nm' class='mngSortBtn' url='/log/getCrmsRqstLogView.do' >신청자</span></th>
						<th><span id='rqst.reqst_detail' class='mngSortBtn' url='/log/getCrmsRqstLogView.do' >신청유형</span></th>
						<th><span id='req_gbn_cd_rel.cde_nm' class='mngSortBtn' url='/log/getCrmsRqstLogView.do' >범죄유형</span></th>
						<th><span id='rqst.cctv_list' class='mngSortBtn' url='/log/getCrmsRqstLogView.do' >CCTV목록</span></th>
						<th><span id='rqst.reqst_dat' class='mngSortBtn' url='/log/getCrmsRqstLogView.do' >신청일</span></th>
						<th><span id='rqst.acpt_dat' class='mngSortBtn' url='/log/getCrmsRqstLogView.do' >승인일</span></th>
						<th><span id='proc_stat_cd_rel.cde_nm' class='mngSortBtn' url='/log/getCrmsRqstLogView.do' >처리상태</span></th>
						<th><span id='use_rs_cd_rel.cde_nm' class='mngSortBtn' url='/log/getCrmsRqstLogView.do' >활용결과</span></th>
                    </tr>
                </thead>
                <tbody>
<%
