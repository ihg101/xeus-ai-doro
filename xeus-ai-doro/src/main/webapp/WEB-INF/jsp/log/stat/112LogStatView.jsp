...
<%
ArrayList<LogStatVo> list112 = (ArrayList<LogStatVo>) request.getAttribute("112");
...
<div>
    <div id="wrap" style="padding-top:10px;">
        <div class="tabTitle">
            <button class="logTab" active="active" url="/log/get112LogStatView.do">112 긴급영상 지원</button>
            ...
            <button class="logTab" url="/log/getEs112LogStatView.do">112 긴급출동</button>
        </div>
        <div id="title" style="padding-top:10px;">112 통계</div>
        <div id="search">
            <span>년도 : </span>
            <select id="year">
...
%>
                    <tr>
                        <td><%= list112.get(i).getGbn() %></td>
                        <td><%= list112.get(i).getAll() %></td>
                        <td><%= list112.get(i).getJan() %></td>
                        <td><%= list112.get(i).getFeb() %></td>
                        <td><%= list112.get(i).getMar() %></td>
                        <td><%= list112.get(i).getApr() %></td>
                        <td><%= list112.get(i).getMay() %></td>
                        <td><%= list112.get(i).getJun() %></td>
                        <td><%= list112.get(i).getJul() %></td>
                        <td><%= list112.get(i).getAug() %></td>
                        <td><%= list112.get(i).getSep() %></td>
                        <td><%= list112.get(i).getOct() %></td>
                        <td><%= list112.get(i).getNov() %></td>
                        <td><%= list112.get(i).getDec() %></td>
                    </tr>
<%
    }
}
