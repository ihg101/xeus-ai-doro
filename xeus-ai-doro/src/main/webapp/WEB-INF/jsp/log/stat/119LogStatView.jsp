...
<%
ArrayList<LogStatVo> list119 = (ArrayList<LogStatVo>) request.getAttribute("119");
...
<div>
    <div id="wrap" style="padding-top:10px;">
        <div class="tabTitle">
            ...
            <button class="logTab" active="active" url="/log/get119LogStatView.do">119 긴급출동</button>
        ...
        <div id="title" style="padding-top:10px;">119 통계</div>
        <div id="search">
            <span>년도 : </span>
            <select id="year">
