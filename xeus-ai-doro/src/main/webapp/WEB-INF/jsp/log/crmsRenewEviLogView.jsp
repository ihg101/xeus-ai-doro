        	...
        	<div class="info_box wd100">
        		<div id="selector">
        			<select>
		                ...
		                <option url="/log/getCrmsRenewEviLogView.do" selected>증거자료신청 로그조회</option>
		                <option url="/log/getCrmsRqstReadingLogView.do">열람신청 로그조회</option>
<!-- 		                <option url="/log/getCrmsRqstCarLogView.do">차량영상반출 로그조회</option> -->
		            </select>
		            <div class="hidden" id="title" url="/log/getCrmsRenewEviLogView.do" excel = "RenewEvi">증거자료신청 로그</div>
        		</div>
...
%> --%>
				 	<th><span id='tt.mgr_seq' class='mngSortBtn' url='/log/getCrmsRenewEviLogView.do' >신청번호</span></th>
	                <th><span id='rqst.reqst_id' class='mngSortBtn' url='/log/getCrmsRenewEviLogView.do' >신청자ID</span></th>
	                <th><span id='rqst_reqst_id_rel.user_nm' class='mngSortBtn' url='/log/getCrmsRenewEviLogView.do' >신청자</span></th>
	                <th><span id='rqst_crime_typ_rel.cde_nm' class='mngSortBtn' url='/log/getCrmsRenewEviLogView.do' >범죄유형</span></th>
	                <th><span id='cctv_no_rel.cctv_nm' class='mngSortBtn' url='/log/getCrmsRenewEviLogView.do' >CCTV명</span></th>
	                <th><span id='work.file_nm' class='mngSortBtn' url='/log/getCrmsRenewEviLogView.do' >영상파일</span></th>
	                <th><span id='tt.play_limit_cnt' class='mngSortBtn' url='/log/getCrmsRenewEviLogView.do' >잔여<br>재생횟수</span></th>
	                <th><span id='avi.play_limit_dat' class='mngSortBtn' url='/log/getCrmsRenewEviLogView.do' >재생만료일</span></th>
	                <th><span id='tt.reqst_resn' class='mngSortBtn' url='/log/getCrmsRenewEviLogView.do' >연장신청사유</span></th>
	                <th><span id='tt.reqst_dat' class='mngSortBtn' url='/log/getCrmsRenewEviLogView.do' >신청일</span></th>
	                <th><span id='tt.acpt_yn' class='mngSortBtn' url='/log/getCrmsRenewEviLogView.do' >승인여부</span></th>
	                <th><span id='tt.acpt_dat' class='mngSortBtn' url='/log/getCrmsRenewEviLogView.do' >승인일</span></th>
                    </tr>
                </thead>
                <tbody>
<%
