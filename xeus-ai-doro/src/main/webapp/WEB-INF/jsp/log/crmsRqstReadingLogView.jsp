        	...
        	<div class="info_box wd100">
        		<div id="selector">
        			<select>
		                ...
		                <option url="/log/getCrmsRqstReadingLogView.do" selected>열람신청 로그조회</option>
<!-- 		                <option url="/log/getCrmsRqstCarLogView.do">차량영상반출 로그조회</option> -->
		            </select>
		            <div class="hidden" id="title" url="/log/getCrmsRqstReadingLogView.do" excel = "RqstReading">열람신청 로그</div>
        		</div>
...
%> --%>
						<th><span id='rqst.mgr_seq' class='mngSortBtn' url='/log/getCrmsRqstReadingLogView.do' >신청번호</span></th>
						<th><span id='rqst.reqst_id' class='mngSortBtn' url='/log/getCrmsRqstReadingLogView.do' >신청자ID</span></th>
						<th><span id='reqst_id_rel.user_nm' class='mngSortBtn' url='/log/getCrmsRqstReadingLogView.do' >신청자</span></th>
						<th><span id='rqst.reqst_detail' class='mngSortBtn' url='/log/getCrmsRqstReadingLogView.do' >신청유형</span></th>
						<th><span id='req_gbn_cd_rel.cde_nm' class='mngSortBtn' url='/log/getCrmsRqstReadingLogView.do' >범죄유형</span></th>
						<th><span id='rqst.cctv_list' class='mngSortBtn' url='/log/getCrmsRqstReadingLogView.do' >CCTV목록</span></th>
						<th><span id='rqst.reqst_dat' class='mngSortBtn' url='/log/getCrmsRqstReadingLogView.do' >신청일</span></th>
						<th><span id='rqst.acpt_dat' class='mngSortBtn' url='/log/getCrmsRqstReadingLogView.do' >승인일</span></th>
						<th><span id='proc_stat_cd_rel.cde_nm' class='mngSortBtn' url='/log/getCrmsRqstReadingLogView.do' >처리상태</span></th>
						<th><span id='use_rs_cd_rel.cde_nm' class='mngSortBtn' url='/log/getCrmsRqstReadingLogView.do' >활용결과</span></th>
                    </tr>
                </thead>
                <tbody>
<%
