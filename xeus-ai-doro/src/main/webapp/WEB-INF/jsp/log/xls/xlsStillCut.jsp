...
ArrayList<MonStillCutLogVo> list = (ArrayList<MonStillCutLogVo>) request.getAttribute("list");
...
String fileName = "CCTV스틸컷 로그현황.xls";
...
<body>
           ...
           <table>
                <thead>
                    <tr align = "center">
                       <td colspan="5" align="center">CCTV스틸컷 로그현황</td>
                    </tr>
                    <tr align="center">
                        <td colspan="2"></td>
