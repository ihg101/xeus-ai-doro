...
ArrayList<MonCctvLogVo> list = (ArrayList<MonCctvLogVo>) request.getAttribute("list");
...
<body>
           ...
           <table>
                <thead>
                    <tr align = "center">
                       <td colspan="8" align="center">영상조회 로그</td>
                    </tr>
                    <tr align="center">
                        <td colspan="5"></td>
