...
<link rel="stylesheet" type="text/css" href="./res/css/xeus.log.css?c=<%= c %>">
...
<script type="text/javascript" src="./res/menu/historyView/gmx.gis.main.js?c=<%= c %>"></script>
<script type="text/javascript" src="./res/menu/historyView/geomex.xeus.history.log.js?c=<%= c %>"></script>
<%-- <script type="text/javascript" src="./res/menu/systemMngView/gmx.cctv.js?c=<%= c %>"></script> --%>
