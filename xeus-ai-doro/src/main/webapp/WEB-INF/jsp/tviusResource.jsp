...
<script type="text/javascript" src="./res/menu/tviusView/gmx.gis.main.js?c=<%= c %>"></script>
<script type="text/javascript" src="./res/menu/tviusView/gmx.cctv.js?c=<%= c %>"></script>
