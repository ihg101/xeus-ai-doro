...
<script type="text/javascript" src="./res/menu/layerAuthView/gmx.gis.main.js?c=<%= c %>"></script>
<script type="text/javascript" src="./res/menu/layerAuthView/gmx.cctv.js?c=<%= c %>"></script>
