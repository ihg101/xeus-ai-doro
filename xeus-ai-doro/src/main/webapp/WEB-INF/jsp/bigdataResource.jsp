...
<script type="text/javascript" src="./res/menu/bigdataView/xeusGlobal-BIGDATA.js?c=<%= c %>"></script>
<script type="text/javascript" src="./res/menu/bigdataView/gmx.gis.main.js?c=<%= c %>"></script>
<script type="text/javascript" src="./res/menu/bigdataView/gmx.cctv.js?c=<%= c %>"></script>
<script type="text/javascript" src="./res/menu/bigdataView/gmx.bigdata.js?c=<%= c %>"></script>
