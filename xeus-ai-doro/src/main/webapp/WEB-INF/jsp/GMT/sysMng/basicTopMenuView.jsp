...
$("#top_menu").find("button.topMenuTab").click(function(){
	if($(this).attr("active") != "active"){
		...
		if(_url != null){// && _mode != null && _supPath != null
			...
			if(_url == "/GMT_userMng/getUserView.do") _param['limit'] = 100;
...
<div id="top_menu">
    <div class="tabTitle" style="margin-top: 0;">
    	<button class="topMenuTab" url="/GMT_userMng/getUserView.do" gbn="user">사용자 관리</button>
		<button class="topMenuTab" url="/GMT_auth/getAuthView.do" gbn="auth">권한 관리</button>
...
<!-- 		<button class="topMenuTab" url="/code/getCodeView.do" gbn="code">코드 관리</button> -->
		<button class="topMenuTab" url="/GMT_notice/getNoticeView.do" gbn="notc">공지사항</button>
		<!-- <button class="topMenuTab" url="/GMT_sysMng/getCctvIconMngView.do" gbn="icon">아이콘 관리</button> -->
	</div>
</div>
