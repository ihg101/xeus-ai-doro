...
<%-- <link rel="stylesheet" type="text/css" href="${ctxPath}/common/ui-1.12.1/jquery-ui.css"> --%>
...
<style>
@font-face { font-family: 'Nanum'; src: url('../res/css/font/NanumGothic.woff') format('woff'); font-weight: normal; font-style: normal; }
...
#list h3 {padding: 15px 0; color: #333; text-indent: 20px; border-bottom: 1px solid #ddd; font-size: 12px; cursor: pointer; outline: 0; position: relative;}
#list h3.ui-state-active {}
...
#list > div {display: flex; flex-direction: column; box-sizing: border-box; padding: 20px; border-bottom: 1px solid #ddd; font-size: 14px;}
#list > div.ui-accordion-content-active {background-color: #fbfdff;}
#list > div > table {width: 100%; margin-top: auto; border-top: 1px solid #ddd;}
#list > div > table th {width:200px; padding: 40px 0;}
</style>
<script>
...
<% for(int i=0; i<list.size(); i++){
	...
	<h3 style="font-weight: bold;"><%= list.get(i).getNotcTitle() %><span style="position: absolute; right: 10px;"><%= DateUtil.formatDate(list.get(i).getLastMdfyDat()) %></span></h3>
	<div>
		<p>
