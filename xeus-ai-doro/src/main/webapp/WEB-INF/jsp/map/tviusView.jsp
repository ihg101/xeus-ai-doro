...
<div id="overlay-west-side-bar" class="overlay-side-bar">
    <!-- 영상반출 신청 -->
    <button id="btn-tvius-lgd-mng" class="menu-button" for="btn-tvus-reg" icon="ico2">범례</button>
    <button id="btn-tvius-cctv-sch" class="menu-button" for="btn-tvus-reg" icon="ico3">CCTV검색</button>
    <button id="btn-tvius-car-sch" class="menu-button" for="btn-tvus-reg" icon="ico11">차량번호취득검색</button>
    <button id="btn-tvius-reg-pag" class="menu-button" for="btn-tvus-reg" icon="ico12" userid="<%= userId %>">영상정보신청</button>
    <button id="btn-tvius-view" class="menu-button" for="btn-tvus-reg" icon="ico13">영상정보신청현황</button>
    <button id="btn-ext-view" class="menu-button" for="btn-tvus-reg" icon="ico14">연장신청현황</button>
    <button id="btn-evi-view" class="menu-button" for="btn-tvus-reg" icon="ico15">증거신청현황</button>
    <button id="btn-tvius-img-view" class="menu-button" for="btn-tvus-reg" icon="ico16" userid="<%= userId %>">이미지반출</button>
</div>
