...
<link rel="stylesheet" type="text/css" href="./res/css/xeus.loader.css?c=<%= c %>">
...
<script type="text/javascript" src="./common/jsZIP-3.6.0/jszip-3.6.0.js?c=<%= c %>"></script>
<script type="text/javascript" src="./common/fileSaver/FileSaver.js?c=<%= c %>"></script>
...
<script type="text/javascript" src="./res/menu/nmsView/gmx.gis.main.js?c=<%= c %>"></script>
<script type="text/javascript" src="./res/menu/nmsView/gmx.cctv.js?c=<%= c %>"></script>
<script type="text/javascript" src="./res/menu/nmsView/gmx.infra.js?c=<%= c %>"></script>
