		...
		if(json.result.length > 0){
			...
			$("#hd_camera_list").change(function(){
				...
				if(mgrNo){
					...
					var isPreview = false; _common.callAjax("/auth/hasAuth.json", { "authData" : "CCTVPREVIEW3M" }, function(json){ isPreview = json.result; }, false);

					hdPlayer = GMXCCTV.createXeusGatePlayer("HD_Player", mgrNo, cctvNm, false, true, isPreview);
				}else{
					hdPlayer.destroy();
				}
			});
