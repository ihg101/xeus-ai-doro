...
<link rel="stylesheet" type="text/css" href="./common/jqContextmenu-v2.9.2/jquery.contextMenu.css?c=<%= c %>">

<link rel="stylesheet" type="text/css" href="./res/css/main-blue.css?c=<%= c %>">
...
<script type="text/javascript" src="./common/jsPDF-2.3.1/jspdf.umd.min.js?c=<%= c %>"></script>
...
<script type="text/javascript" src="./common/jsmpeg.min20171213.js?c=<%= c %>"></script>
<script type="text/javascript" src="./common/pagination-2.1.5/jquery.pagination.js?c=<%= c %>"></script>
<script type="text/javascript" src="./common/jqContextmenu-v2.9.2/jquery.contextMenu.min.js?c=<%= c %>"></script>
<script type="text/javascript" src="./common/jqContextmenu-v2.9.2/jquery.ui.position.min.js?c=<%= c %>"></script>
...
<!-- <script type="text/javascript" src="http://dapi.kakao.com/v2/maps/sdk.js?appkey=51b6a4d82df686d0f4c9109b1ab39c01"></script> -->
...
<script type="text/javascript" src="./res/menu/eventView/xeusGlobal-CCTV.js?c=<%= c %>"></script>
<script type="text/javascript" src="./res/menu/nmsView/xeusGlobal-NMS.js?c=<%= c %>"></script>
<script type="text/javascript" src="./res/menu/eventView/gmx.gis.main.js?c=<%= c %>"></script>
<script type="text/javascript" src="./res/menu/eventView/gmx.cctv.js?c=<%= c %>"></script>
