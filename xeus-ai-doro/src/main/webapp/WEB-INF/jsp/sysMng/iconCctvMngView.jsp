 ...
 * CCTV
 */
HashMap<String, String> cctvMap = cde.convertCodeGrpToAllCde("C14");
Set<String> cctvKey = new TreeSet<String>(cctvMap.keySet());
Iterator<String> cctvItr = cctvKey.iterator();
...
/* while (cctvItr.hasNext()) {
    String str = (String) cctvItr.next();
} */
...
<!-- <title>CCTV 아이콘 관리 | XEUS-Platform</title>
</head>
<body> -->
<div>
    ...
    <div id="wrap" style="display: none;">
        <p class="searchTitle">
            <button class="iconTab" active="active" url="/sysMng/getCctvIconMngView.do" mode="ctv" subpath="cctv">CCTV 아이콘 관리</button>
...
<%
    cctvItr = cctvKey.iterator();
    while (cctvItr.hasNext()) {
        String str = (String) cctvItr.next();
%>
                                <option value="<%= str %>"><%= cctvMap.get(str) %></option>
<%
    }
%>
                            </select>
