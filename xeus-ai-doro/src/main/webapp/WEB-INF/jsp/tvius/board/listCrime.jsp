...
<div id="searchBox" class="customScroll" style="width: 100%; height: 100%; overflow-x: hidden; overflow-y: visible; box-sizing: border-box; padding: 0 15px">
    ...
    <div class="contentWrapper statTable customScroll hidden" style="height: 40% !important;">
        <h3 class="title">범죄유형별 신청현황</h3>
        <div class="box_style">
        ...
        <table id="listcrime" border="0" cellspacing="0">
<!--             <colgroup> -->
<!--                 <col width="9%" /> -->
<!--                 <col width="7%" /> -->
<!--                 <col width="7%" /> -->
