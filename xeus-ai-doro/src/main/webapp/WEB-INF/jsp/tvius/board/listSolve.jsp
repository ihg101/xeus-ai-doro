...
<div id="searchBox" class="customScroll" style="width: 100%; height: 100%; overflow-x: hidden; overflow-y: visible; box-sizing: border-box; padding: 0 15px">

    <div class="contentWrapper statTable customScroll hidden" style="height: 333px;">
        <h3 class="title">사건해결 기여율</h3>
        ...
        <table id="listsolve" border="0" cellspacing="0">
<!--             <colgroup> -->
<!--                 <col width="9%" /> -->
<!--                 <col width="7%" /> -->
<!--                 <col width="7%" /> -->
...
%>
        ...
        <div id="chart_title" style="margin: 15px 0 10px 0">
            <ul>
                <%
                    ...
                    for ( int i = 1; i < (chartTitle.length-2) ; i++ ) {
    ...
    <script type="text/javascript">
        ...
        var chartarr = [
                    <%
                        for ( int i = 1; i < (chartStr.length-2); i++ ) {
