...
<div id="searchBox" class="customScroll" style="width: 100%; height: 100%; overflow-x: hidden; overflow-y: visible; box-sizing: border-box; padding: 15px;">
    ...
    <div class="contentWrapper statTable customScroll" style="width: 100%;"><!-- height: 40% !important;  -->
...
%>
    ...
    <% } else {%>
    <div class="contentWrapper statChart customScroll" style="height: 340px; text-align: center;" >
    <% }%>
